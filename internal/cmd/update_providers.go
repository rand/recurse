...
recurse update-providers

# Update Catwalk providers from a custom URL
recurse update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
recurse update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
recurse update-providers embedded

# Update Hyper provider information
recurse update-providers --source=hyper

# Update Hyper from a custom URL
recurse update-providers --source=hyper https://hyper.example.com
`,
