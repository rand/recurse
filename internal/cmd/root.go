...
import (
	...
	"github.com/rand/recurse/internal/projects"
	"github.com/rand/recurse/internal/stringext"
	"github.com/rand/recurse/internal/tui"
...
func init() {
	...
	rootCmd.PersistentFlags().StringP("data-dir", "D", "", "Custom recurse data directory")
...
var rootCmd = &cobra.Command{
	Use:   "recurse",
	Short: "A recursive language model system for agentic coding",
	Long:  "A recursive language model (RLM) system with hypergraph memory for agentic coding",
	Example: `
...
recurse -d -c /path/to/project

# Run with custom data directory
recurse -D /path/to/custom/.recurse
  ...
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := program.Run(); err != nil {
			...
			return errors.New("Recurse crashed. If metrics are enabled, we were notified about it. If you'd like to report it, please copy the stacktrace above and open an issue at https://github.com/rand/recurse/issues/new?template=bug.yml") //nolint:staticcheck
		}
		return nil
	},
...
func shouldEnableMetrics() bool {
	if v, _ := strconv.ParseBool(os.Getenv("RECURSE_DISABLE_METRICS")); v {
		return false
	}
