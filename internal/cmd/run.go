...
curl https://charm.land | recurse run "Summarize this website"

# Read from a file
recurse run "What is this code doing?" <<< prrr.go

# Run in quiet mode (hide the spinner)
recurse run --quiet "Generate a README for this project"
  `,
