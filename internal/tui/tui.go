...
import (
	...
	"github.com/rand/recurse/internal/stringext"
	cmpChat "github.com/rand/recurse/internal/tui/components/chat"
	...
	"github.com/rand/recurse/internal/tui/components/core/status"
...
func (a *appModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	// RLM Trace
	case commands.OpenRLMTraceDialogMsg:
		if a.dialog.ActiveDialogID() == rlmtrace.RLMTraceDialogID {
			return a, util.CmdHandler(dialogs.CloseDialogMsg{})
		}
		// Check if RLM service is available
		if a.app.RLM == nil {
			return a, util.ReportWarn("RLM service not available")
		}
		return a, util.CmdHandler(dialogs.OpenDialogMsg{
	...
	case pubsub.UpdateAvailableMsg:
		...
		statusMsg := fmt.Sprintf("Recurse update available: v%s → v%s.", msg.CurrentVersion, msg.LatestVersion)
		if msg.IsDevelopment {
			statusMsg = fmt.Sprintf("This is a development version of Recurse. The latest version is v%s.", msg.LatestVersion)
		}
