...
import (
	...
	"github.com/rand/recurse/internal/log"
...
func GlobalConfig() string {
	if crushGlobal := os.Getenv("RECURSE_GLOBAL_CONFIG"); crushGlobal != "" {
...
func GlobalConfigData() string {
	if crushData := os.Getenv("RECURSE_GLOBAL_DATA"); crushData != "" {
...
func GlobalSkillsDirs() []string {
	if crushSkills := os.Getenv("RECURSE_SKILLS_DIR"); crushSkills != "" {
