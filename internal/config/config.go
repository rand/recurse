...
import (
	...
	hyperp "github.com/rand/recurse/internal/agent/hyper"
	"github.com/rand/recurse/internal/csync"
	"github.com/rand/recurse/internal/env"
	"github.com/rand/recurse/internal/oauth"
	"github.com/rand/recurse/internal/oauth/copilot"
	"github.com/rand/recurse/internal/oauth/hyper"
...
type Options struct {
	...
	SkillsPaths               []string     `json:"skills_paths,omitempty" jsonschema:"description=Paths to directories containing Agent Skills (folders with SKILL.md files),example=~/.config/recurse/skills,example=./skills"`
	TUI                       *TUIOptions  `json:"tui,omitempty" jsonschema:"description=Terminal user interface options"`
	Debug                     bool         `json:"debug,omitempty" jsonschema:"description=Enable debug logging,default=false"`
	DebugLSP                  bool         `json:"debug_lsp,omitempty" jsonschema:"description=Enable debug logging for LSP servers,default=false"`
	DisableAutoSummarize      bool         `json:"disable_auto_summarize,omitempty" jsonschema:"description=Disable automatic conversation summarization,default=false"`
	DataDirectory             string       `json:"data_directory,omitempty" jsonschema:"description=Directory for storing application data (relative to working directory),default=.recurse,example=.recurse"` // Relative to the cwd
