...
import (
	...
	"github.com/rand/recurse/internal/env"
...
func TestConfig_setDefaults(t *testing.T) {
	...
	require.Equal(t, filepath.Join("/tmp", ".recurse"), cfg.Options.DataDirectory)
...
func TestConfig_setupAgentsWithDisabledTools(t *testing.T) {
	...
	assert.Equal(t, []string{"agent", "bash", "job_output", "job_kill", "multiedit", "lsp_diagnostics", "lsp_references", "fetch", "agentic_fetch", "glob", "ls", "sourcegraph", "todos", "view", "write", "rlm_execute", "rlm_peek", "rlm_externalize", "rlm_status", "rlm_service_status", "rlm_memory_query"}, coderAgent.AllowedTools)
...
func TestConfig_setupAgentsWithEveryReadOnlyToolDisabled(t *testing.T) {
	...
	coderAgent, ok := cfg.Agents[AgentCoder]
	require.True(t, ok)
	assert.Equal(t, []string{"agent", "bash", "job_output", "job_kill", "download", "edit", "multiedit", "lsp_diagnostics", "lsp_references", "fetch", "agentic_fetch", "todos", "write", "rlm_execute", "rlm_peek", "rlm_externalize", "rlm_status", "rlm_service_status", "rlm_memory_query"}, coderAgent.AllowedTools)
